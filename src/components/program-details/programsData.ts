...
export const programs = {
  ...
  "programa-bienestar": {
    ...
    details: {
      ...
      instructors: [
        {
          name: "Juan Manueal Fonseca",
          role: "Coach de Nutrición",
          image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158",
          bio: "Nutricionista certificada especializada en alimentación funcional."
        },
        {
          name: "Roberto Juárez",
          role: "Entrenador Personal",
          image: "https://images.unsplash.com/photo-1581092795360-fd1ca04f0952",
          bio: "Especialista en entrenamiento funcional y rehabilitación física."
        }
      ],
      includes: [
      ...
      instructors: [
        {
          ...
          image: "https://images.unsplash.com/photo-1581092795360-fd1ca04f0952",
          bio: "Custodio de tradiciones ancestrales con más de 20 años de experiencia."
        },
        {
          name: "Elena Ramírez",
          role: "Terapeuta Holística",
          image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158",
          bio: "Especialista en terapias naturales y conexión con la madre tierra."
        }
      ],
      includes: [
