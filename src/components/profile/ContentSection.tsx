...
import { Lock, BookOpen, Video, FileText, Calendar } from "lucide-react";
      ...
      <CardContent className="p-6">
        {userPlan === "none" ? (
          <div className="text-center py-12 px-4">
            ...
            <Button onClick={onUpgrade} size="lg" className="px-8">Ver Planes</Button>
          </div>
        ) : userPlan === "basic" ? (
          <div className="space-y-6">
            ...
            <div className="pt-4 text-center">
              <Button variant="outline" onClick={onUpgrade}>Mejorar mi Plan</Button>
            </div>
          </div>
        ) : userPlan === "gold" ? (
          <div className="space-y-6">
            ...
            <div className="pt-4 text-center">
              <Button variant="outline" onClick={onUpgrade}>Mejorar a VIP</Button>
            </div>
          </div>
        ) : userPlan === "vip" ? (
          <div className="space-y-6">
